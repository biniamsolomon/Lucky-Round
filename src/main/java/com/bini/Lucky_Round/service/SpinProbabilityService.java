...
public class SpinProbabilityService {
    ...
    public SpinRewardResponse processRequest(SpinRewardRequest spinRequest, Logger logManager) {
        ...
        if (REGISTRATION.equals(transactionType)
            ...
            logManager.info("First Transaction Received for " + msisdn);
        ...
        logManager.info("Received reward request " + spinRequest.toString());
        ...
        Random rand = new Random();
            ...
            if (transactionProbability > 0 && rand.nextDouble() <= transactionProbability) {
                ...
                logManager.info("Transaction Probability passed : " + spinRequest.toString());
                ...
                if (!isWithinHourlyLimit(reasonTypeId, Double.parseDouble(prizeValue),  allocationPercentage)) {
                    ...
                    logManager.info("Hourly budget exceeded with value of= " + allocationPercentage + prizeValue);
